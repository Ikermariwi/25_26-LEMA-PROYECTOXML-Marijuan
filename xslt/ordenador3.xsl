    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <p class="introduccion"> Total de productos: <xsl:value-of
                        select="count($XMLordenador//componentes/*)" />
                </p>
                        ...
                        <xsl:for-each select="$XMLordenador//ordenador/componentes/procesador">
                            <li class="producto">
                                <article>
                                    ...
                                    <!-- Precio original -->
                                    <p>Precio: <strong><xsl:value-of select="precio" />€</strong>
                                    </p>

                                    <!-- Precio sin IVA -->
                                    <p>Precio sin IVA: <xsl:value-of
                                            select="format-number(number(precio) div 1.21,'#0')" />€ </p>

                                    <!-- Precio con IVA -->
                                    <p>Precio con IVA: <xsl:value-of
                                            select="format-number(number(precio) * 1.21,'#0')" />€ </p>

                                    <!-- Precio con descuento del 10% -->
                                    <p>Descuento 10%: <xsl:value-of
                                            select="format-number(number(precio) * 0.9,'#0')" />€ </p>
